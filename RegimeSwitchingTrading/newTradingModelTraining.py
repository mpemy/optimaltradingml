...
""" dfAAPL =pd.read_csv("~/codes/AAPLIntradayOf5-1-2017.csv")              #dfAAPL = pd.read_csv("C:/Temp/TradingPaper/AAPLIntradayOf5-1-2017.csv")
dfGOOG = pd.read_csv("~/codes/GOOGIntradayOf5-1-2017.csv")
dfT = pd.read_csv("~/codes/TIntradayOf5-1-2017.csv")
dfVZ = pd.read_csv("~/codes/VZIntradayOf5-1-2017.csv")
dfXOM = pd.read_csv("~/codes/XOMIntradayOf5-1-2017.csv")
dfIBM = pd.read_csv("~/codes/IBMIntradayOf5-1-2017.csv") """

dfAAPL =pd.read_csv("/Users/nazhang/Desktop/Research/MachingLearning-Financial Math/FullDataSet/AAPLIntradayOf5-1-2017.csv") #    pd.read_csv("C:/Temp/TradingPaper/AAPLIntradayOf4-1-2017.csv")
dfGOOG = pd.read_csv("/Users/nazhang/Desktop/Research/MachingLearning-Financial Math/FullDataSet/GOOGIntradayOf5-1-2017.csv")
dfT = pd.read_csv("/Users/nazhang/Desktop/Research/MachingLearning-Financial Math/FullDataSet/TIntradayOf5-1-2017.csv")
dfVZ = pd.read_csv("/Users/nazhang/Desktop/Research/MachingLearning-Financial Math/FullDataSet/VZIntradayOf5-1-2017.csv")
dfXOM = pd.read_csv("/Users/nazhang/Desktop/Research/MachingLearning-Financial Math/FullDataSet/XOMIntradayOf5-1-2017.csv")
dfIBM = pd.read_csv("/Users/nazhang/Desktop/Research/MachingLearning-Financial Math/FullDataSet/IBMIntradayOf5-1-2017.csv")
...
S = []
tempAAPL =[]
for j in range(0, len(dfAAPL["Price"])):
    tempAAPL.append(dfAAPL["Price"][j])

tempGOOG =[]
for j in range(0, len(dfGOOG["Price"])):
    tempGOOG.append(dfGOOG["Price"][j]) 

tempIBM=[]    
for j in range(0, len(dfIBM["Price"])):
    tempIBM.append(dfIBM["Price"][j])     

tempT=[]
for j in range(0, len(dfT["Price"])):
    tempT.append(dfT["Price"][j])     

tempVZ=[]
for j in range(0, len(dfVZ["Price"])):
    tempVZ.append(dfVZ["Price"][j])     

tempXOM=[]
for j in range(0, len(dfXOM["Price"])):
...
for j in range(1, len(dfAAPL["Volume"])):
    tempAAPL.append(dfAAPL["Volume"][j] - dfAAPL["Volume"][j-1])

tempGOOG =[]
for j in range(1, len(dfGOOG["Volume"])):
    tempGOOG.append(dfGOOG["Volume"][j] - dfGOOG["Volume"][j-1] ) 

tempIBM=[]    
for j in range(1, len(dfIBM["Volume"])):
    tempIBM.append(dfIBM["Volume"][j] - dfIBM["Volume"][j-1])     

tempT=[]
for j in range(1, len(dfT["Volume"])):
    tempT.append(dfT["Volume"][j]- dfT["Volume"][j-1])     

tempVZ=[]
for j in range(1, len(dfVZ["Volume"])):
    tempVZ.append(dfVZ["Volume"][j] - dfVZ["Volume"][j-1])     

tempXOM=[]
for j in range(1, len(dfXOM["Volume"])):
    tempXOM.append(dfXOM["Volume"][j] - dfXOM["Volume"][j-1])         
