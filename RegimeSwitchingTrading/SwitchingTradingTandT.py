...
#from SwitchingTradingModelTrainingWeek2ModelBased import SwitchingTradingTrainingEnv
from SwitchingTradingModelTrainingWeek1ModelBased import SwitchingTradingTrainingEnv
#from SwitchingTradingModelTrainingWeek2 import SwitchingTradingTrainingEnv

#from SwitchingTradingModelTestingWeek2 import SwitchingTradingTestingEnv
from SwitchingTradingModelTestingWeek1 import SwitchingTradingTestingEnv
##env= gym.make("LunarLander-v2")

env = SwitchingTradingTrainingEnv()
#env = TradingEnv()
...
'''
agentoo7 = agent()
steps =4 #4 in week2 , equal 3 for week1 
total = 1500  #200 #batch size
nber=0
...
testingEnv = SwitchingTradingTestingEnv() 
agentoo7 = agent()
steps = 8
total = 215 # batch size
nber=0
for s in range(steps):
  ...
  while step<total:
    ...
    if step>=total:
      ...
      #print("total step for this episord are {}".format(t))
      print("total reward after {} steps is {} step {}",s, total_reward, nber)
      rk = nber
      testingEnv.newplotter(rk)
